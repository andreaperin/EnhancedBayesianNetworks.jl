...
jd_node = ContinuousStandardNode(:jd, jd_parents, jd_dist)
...
E = DiscreteFunctionalNode(:E, [H, V, time, jd_node], models, performances, simulations)

ebn = EnhancedBayesianNetwork([H, V, R1, R2, R3, R4, R5, jd_node, time, E])
