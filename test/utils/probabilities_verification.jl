@testset "Verify Probabilities" begin
    @testset "Precise Nodes" begin
        ...
        @test_throws ErrorException("states [:yes, :no] are not exhaustives and mutually exclusive. Their probabilities [0.8, 0.8] does not sum up to 1") EnhancedBayesianNetworks._verify_probabilities(states)
